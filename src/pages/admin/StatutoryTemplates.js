    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            ...
            <div className="mb-6 flex justify-between items-center">
                ...
                <Link
                    to="/admin/statutory-templates/create"
                            ...
                            {templates.map((template) => (
                                <tr key={template._id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm">
                                        <span className={`px-2 py-1 rounded-full text-xs ${template.category === 'EARNING' ? 'bg-green-100 text-green-800' :
                                    ...
                                    <td className="px-6 py-4 text-sm">
                                        <span className={`px-2 py-1 rounded-full text-xs ${template.isAttendanceBased ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                                            }`}>
                                    ...
                                    <td className="px-6 py-4 text-sm">
                                        <div className="flex gap-2">
                                            <Link
                                                to={`/admin/statutory-templates/edit/${template._id}`}
